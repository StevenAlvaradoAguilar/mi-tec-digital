...
public class App  {
    ...
    public static void main(String[] args) {
        ...
        var cursoService = applicationContext.getCursoServiceSet();
    ...
    public static void addNewStudent(CursoService cursoService, int id, String nombre, int creditos, String departamento) {
    ...
    public static void showTeacherInfo(ProfesorService profesorService, int id) {
        ...
        if(profesor.isPresent()) {
            ...
            System.out.println("Estudiante con carne: " + id + " no existe");
        }
    }
