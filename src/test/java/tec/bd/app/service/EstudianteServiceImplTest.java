...
public class EstudianteServiceImplTest {
    ...
    public void getStudentsByLastName() throws Exception {
        ...
        given(estudianteDAO.findByLastName(anyString())).willReturn(estudiantes);

        var actual = this.estudianteService.getStudentsByLastName("Juan");

        verify(estudianteDAO, times(1)).findByLastName("Juan");
